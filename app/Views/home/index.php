...
<section class="py-12 mx-10">
  ...
  <div class="flex flex-col md:flex-row items-center md:divide-x md:divide-gray-300">
    ...
    <div class="w-full md:w-1/3 flex flex-col items-center p-8 p-8">
      <div>
    ...
    <div class="w-full md:w-1/3 flex flex-col items-center p-8">
      <div>
...
<section class="bg-[#BAF200] text-black py-12" id="contact-us">
